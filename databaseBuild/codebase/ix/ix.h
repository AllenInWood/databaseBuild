...
public:
    ...
    /*
     * Search the appropriate place to insert the new key in the existed index pages
     * Return the
     */
    ...
    RC insertOnIndexPage( IXFileHandle &ixfileHandle, void *memory, const void *key, AttrType type );


    /* Update a non-leaf page and delete a redundant node */
    RC updateIndexPage( IXFileHandle &ixfileHandle, void *memory, const void *key, AttrType type, void *midKey, bool leftOrRight );
